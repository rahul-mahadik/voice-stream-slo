"""OpenAI chunked-HTTP PCM adapter."""
...
class OpenAIAdapter(ProviderAdapter):
    ...
    async def synthesize(self, trace_id: str, prompt_id: str, text: str) -> Trace:
        ...
        async with self._client.stream("POST", self.config.endpoint, json=payload) as response:
        ...
        return self._trace(
            ...
            metadata={"response_format": "pcm", "http_version": response.http_version},
        )
